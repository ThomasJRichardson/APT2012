<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="TrusteeInvestmentAllocation.aspx.cs" Inherits="APT2012.TrusteeInvestmentAlloccation" %>
...
<asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
    <div class="reporting">
        ...
        <h2>
            <asp:Label runat="server" ID="lblPageHeader" Text="Investment Allocation" /></h2>
        <p>
            <asp:Label runat="server" ID="lblPageHeaderByline" Text="The investment allocation of all members in this scheme." /></p>
    </div>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="fullbox clear">
        <h3>
            <asp:Label ID="Label1" runat="server" Text="Investment Allocation"></asp:Label></h3>
