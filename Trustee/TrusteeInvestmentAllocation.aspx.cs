...
namespace APT2012
{
    public partial class TrusteeInvestmentAlloccation : APTBasePage // System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                if (!IsPostBack)
                {
                    ...
                    ReportViewer1.ServerReport.ReportPath = "/APT.Reports/TrusteeSchemeMemberInvestmentAlloc";
