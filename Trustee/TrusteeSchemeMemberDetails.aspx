<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="TrusteeSchemeMemberDetails.aspx.cs" Inherits="APT2012.TrusteeSchemeMemberDetails" %>
...
<asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
    <div class="reporting">
        ...
        <h2>
            <asp:Label runat="server" ID="lblPageHeader" Text="Member Details" /></h2>
        <p>
            <asp:Label runat="server" ID="lblPageHeaderByline" Text="The member details for all members in this scheme." /></p>
    </div>
</asp:Content>
