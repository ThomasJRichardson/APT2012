<%@ Page Title="" Language="C#" MasterPageFile="~/IPPP/IPPP.Master" AutoEventWireup="true"
    CodeBehind="faq.aspx.cs" Inherits="APT2012.IPPP.faq" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="contentbody" runat="server">
    <h2 style="text-align: center;">
        <strong>Wind Up of the Irish Permanent Pension Plan (“the Plan”)</strong></h2>
    <h2>
        Why did the Trustees resolve to wind up the Irish Permanent Pension Plan?</h2>
    <p>
        Permanent tsb (“the Bank) gave notice that it was ceasing to voluntarily contribute
        to the Plan with effect from 31 May 2013. The bank had already notified the Trustees
        by notice dated 4 March 2013 that it was ceasing liability to contribute and that
        ...
        up the Plan with effect from 31 May 2013.</p>
    <h2>
    ...
    <p>
        ...
        any more benefits under the Plan after 31 May 2013 and will become deferred members
        ...
        of the Plan and uses your final salary as at 31 May 2013 and your pensionable service
        up to that date.</p>
    <p>
    ...
    <p>
        Members who were in receipt of a pension from the Plan at 31 May 2013 will continue
    ...
    <p>
        Each member’s status is frozen as at the date of wind up, i.e. at 31 May 2013. This
        means that a member reaching normal retirement age after 31 May 2013 will not become
    ...
    <p>
        ...
        <p>
            ...
            wind up. The Trustees understand that the Bank has put alternative death in service
            cover in place for current employees. If any active or deferred member of the Plan
            dies after 31 May 2013, the amount due to them as part of the wind up will still
        ...
        <p>
            Yes, this option is still open to members. If you are interested in pursuing this
            option please contact the administrator.
        </p>
        <h2>
            How are the benefits met on wind up?</h2>
        <p>
            The Pensions Act 1990 (as amended) sets out the priority of benefits on wind up,
        ...
        <h2>
            What is a transfer value?</h2>
        <p>
            A transfer value is the present day value of your future deferred benefit from the
            Plan as determined under the MFS using a basis specified by the Society of Actuaries
            in Ireland and approved by the Minister for Social Protection.
        </p>
        <h2>
            When will members receive their AVCs?</h2>
        <p>
            AVCs will be payable at the time transfer values are paid out to members and details
            of your AVC holdings will be communicated to you at this time. Please note that
            you are not able to continue making AVCs to the Plan after the wind up date, however,
            you are still entitled to direct how your AVCs should be invested during the wind
            up process. If you wish to review or change your AVC investment fund choice please
        ...
        <p>
            ...
            so for all current employees of the Bank who are members of the Plan, pensionable
            service will cease on 31 May 2013. The Trustees of the Plan are not involved in
            any discussions regarding pension provision after this date and it is a matter for
            the Bank and its employees.</p>
        <h2>
        ...
        <p>
            ...
            Apex Business Centre,<br />
            Blackthorn Road, Sandyford,<br />
            Dublin 18<br />
            Tel 01 2063010<br />
            Contact Aidan Lambe<br />
            <a href="mailto:alambe@alliedpensions.com">alambe@alliedpensions.com</a></p>
</asp:Content>
