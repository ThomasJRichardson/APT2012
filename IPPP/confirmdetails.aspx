...
<asp:Content ID="Content2" ContentPlaceHolderID="contentbody" runat="server">
    ...
    <div class="form">
        ...
        <h6>
            Please review and update where appropriate, especially your contact details. Then either confirm or correct your service record using the option below and you can then Submit all changes to us. Note that your service record amendments will need to be approved before this page is updated.
        </h6>
        <p>
            PPSN<asp:TextBox Text="" name="PPSN" ID="txtPPSN" MaxLength="50" size="100"
                runat="server" />
        </p>
        <p>
            Surname
        ...
        <p>
            Forename(s)<asp:TextBox Text="" name="Forename" ID="txtForename" MaxLength="50"
            ...
            <p>
                Email Address<asp:TextBox Text="" name="EmailAddress" ID="txtEmailAddress"
            ...
            <p class="fullwidth">
                <asp:Label ID="lblPersonal" Text="Your personal details were last updated online at 10:17 on 04/12/2013."
                    runat="server" />
            </p>
            <h4>
            ...
            <asp:Panel ID="pnlSRecord2" Visible="false" runat="server">
                <h4>
            ...
            <asp:Label ID="lblServiceRecordUpdated" runat="server" Text="Your service record was last updated by the Administrators at 10:17 on 04/12/2013" />

            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    <p class="fullwidth">
                        <asp:RadioButtonList ID="rblConfirm" runat="server" OnSelectedIndexChanged="rblConfirm_SelectedIndexChanged"
                            AutoPostBack="True">
                            <asp:ListItem Text="I confirm my details are correct" Value="true" />
                            <asp:ListItem Text="No my details are incorrect" Value="false" />
                        </asp:RadioButtonList>
                    </p>
                    <asp:Panel ID="pnlEdit" Visible="false" runat="server">
                        <div id="editablerecords_wrapper">
                            ...
                            <asp:Panel ID="pnlESRecord" runat="server" Visible="false">
                        ...
                        <p class="fullwidth">
                            <asp:Label ID="lblServices" Text="You submitted amendments at 10:17 on 04/12/2013 and they are under reviewe by the
                ...
                <Triggers>
                    <asp:AsyncPostBackTrigger ControlID="rblConfirm" EventName="SelectedIndexChanged" />
