...
namespace APT2012
{
    ...
    public class SqlStoredProcedureProfileProvider : ProfileProvider
    {
        ...
        //private static string APT2012AssemblyInfo_AssemblyInfo = "APT2012";
        //private static string APT2012AssemblyInfo_SUBSYSTEM = "APT2012";
        ...
        public override void Initialize(string name, NameValueCollection config)
        {
            ...
            catch (Exception ex)
            {
                ...
                // APTLog.LogException(ex, stackTrace.GetFrame(0).GetMethod().Name, APT2012AssemblyInfo_AssemblyInfo, APT2012AssemblyInfo_SUBSYSTEM);
                //throw ex;
            }
        }
        ...
        private void GetProfileDataFromSproc(SettingsPropertyCollection properties,
                                            SettingsPropertyValueCollection svc, string username,
                                            SqlConnection conn, bool userIsAuthenticated)
        {
