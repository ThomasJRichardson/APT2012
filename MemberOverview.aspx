<%@ Page Title="" Language="C#" EnableEventValidation="false" MasterPageFile="~/Site.Master"
    AutoEventWireup="true" CodeBehind="MemberOverview.cs" Inherits="APT2012.MemberOverview"
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Panel ID="pnlInvVsCont" runat="server" meta:resourcekey="pnlInvVsContResource1">
        <div class="clear fullbox">
            ...
            <div style="text-align: center;">
                ...
                <asp:Label CssClass="chartNote" ID="lblCvsIInfo" runat="server" Text="The above graph shows the value of your investment by comparison to your contributions paid over the last 12 months.<br/> Sharp declines in the investment value may occur as a result of fund switching and is not always a reflection of your fund performance."
    ...
    <div class="clear">
        <div class="leftbox">
            ...
            <table cellpadding="0" cellspacing="0" border=0 class="summarytable">
                <tr>
                    <td>
        ...
        <div class="rightbox">
            ...
            <table cellpadding="0" cellspacing="0" class="summarytable">
                ...
                <tr>
                    <td>
                        <asp:Label ID="lblAVCs" runat="server" Text="AVCs" meta:resourcekey="lblAVCsResource1"></asp:Label>
                    </td>
                    <td>
    ...
    <div class="fullbox clear">
        ...
        <asp:GridView CssClass="investmentsSummary" ID="gvInvestmentSummary" runat="server"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="Price" HeaderText="Unit Price" DataFormatString="{0:c4}" meta:resourcekey="BoundFieldResource3" />
                <asp:BoundField DataField="Units" HeaderText="Units Held"  DataFormatString="{0:f4}" meta:resourcekey="BoundFieldResource4" />
                <asp:BoundField DataField="Value" HeaderText="Value" DataFormatString="{0:c2}" meta:resourcekey="BoundFieldResource5" />
            </Columns>
            <EmptyDataTemplate>
