<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="GroupDCSORP.aspx.cs" Inherits="APT2012.GroupDCSORP" %>    
...
<asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
    ...
    <div class="reporting">
        ...
        <h2>
            <asp:Label runat="server" ID="lblPageHeader" Text="Group Defined Contribution SORP" /></h2>
        <p>
            <asp:Label runat="server" ID="lblPageHeaderByline" Text="Report for Defined Contribution Statement of Resonable Projection" /></p>
    </div>
</asp:Content>
