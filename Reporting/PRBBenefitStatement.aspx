<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PRBBenefitStatement.aspx.cs" Inherits="APT2012.PRBBenefitStatement" meta:resourcekey="PageResource1"  %>
...
<asp:Content ID="cntTitle" runat="server" contentplaceholderid="ContentPlaceHolderPageTitle">
    ...
    <div class="reporting">
        ...
        <h2>
            <asp:Label runat="server" ID="lblPageHeader" Text="PRB Benefit Statement" meta:resourcekey="lblPageHeaderResource1" /></h2>
        <p class="h2-line">
            <asp:Label runat="server" ID="lblPageHeaderByline" Text="PRB Benefit Statement" meta:resourcekey="lblPageHeaderBylineResource1" /></p>
    </div>                    
</asp:Content>
